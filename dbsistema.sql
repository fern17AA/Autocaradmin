...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-04-2022 a las 15:28:15
...
(6, 8, '00436534', 'VEHICULO DE TRANSPORTE', 26, 'vehículo urbano para la empresa UT CANCÚN', '1649172701.png', 1);
...
(7, 'Publicidad', 'teclados gamers', 1),
(8, 'Renta de vehículo', 'cpus gamers de alta categoria', 1),
(9, 'Boletos', 'disco solidos', 1),
(12, 'venta especial AUTOCAR', 'monitores gamers', 1);
...
(12, 10, 6, 'Ticket', '9898798', '9', '2022-04-05 00:00:00', '0.00', '1.00', 'Aceptado');
...
(7, 'Proveedor', 'TELEMETRIA', 'RUC', '12587845254', 'Av. los pinos 201', '54328730', 'telemetria@hotmail.com'),
